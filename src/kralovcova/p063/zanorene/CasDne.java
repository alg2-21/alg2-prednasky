...
class CasDne {
    ...
    public static final String FORMAT_STRING
            = "%2d" + TIME_PARTS_SEPARATOR + "%2d" + TIME_PARTS_SEPARATOR
            + "%2d" + TIME_PARTS_SEPARATOR + "%2d";
    ...
    /**
     * Vytvori instanci ze zadaneho poctu milisekund
     * vzhledem k implementaci tridy dojde ke ztrate informace 
     * (jednotky sekund nejsou zaznamenane/zachovane ve vytvorene instanci)
    ...
    /**
     * Z textoveho retezce, ve kterem jsou dilci casove udaje oddelene dvojteckou
     * vytvori objekt tridy
     * casovyUdaj nemusi obsahovat vsechny ctyri dilci udaje, v tom pripade 
     * ty s mensi vyznamnosti nabyvaji hodnoty 0
     * @param casovyUdaj textovy retezec s casovy udajem
     * @return neve vytvoreny objekt
     * @throws InputMismatchException v pripade chybneho formatu textoveho retezce 
     * a textovy retezec tak nelze prevest na CasDne
     */
    ...
    public String toString() {
        return "" + hod + TIME_PARTS_SEPARATOR + min + TIME_PARTS_SEPARATOR + 
                sek + TIME_PARTS_SEPARATOR + set + TIME_PARTS_SEPARATOR + pocetMilis;
    }
